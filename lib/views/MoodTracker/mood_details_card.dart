...
class MoodDetailsCard extends StatelessWidget {
  final MoodModel? mood;

  const MoodDetailsCard({super.key, required this.mood});
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                gradient: LinearGradient(
                  colors: [
                    Color(0xff7F2BFF),
                    Color(0xffB57CFF).withOpacity(0.7),
                  ],
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: Image.asset(
                          moodController.getImage(mood?.mood ?? ''),
                          width: 120 * scale,
                          height: 120 * scale,
                        ),
                      ),
                      ...
                      Container(
                        ...
                        child: Row(
                          children: [
                            ...
                            Expanded(
                              child: Text(
                                "You felt ${mood?.mood ?? ''} on this day",
                                style: TextStyle(
