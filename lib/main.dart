...
void main() {
  ...
  runZonedGuarded(
    () async {
      ...
      const trackerAlarmChannel = MethodChannel(
        'com.coretegra.snevva/tracker_alarm',
      );
      trackerAlarmChannel.setMethodCallHandler((call) async {
        if (call.method == 'onAlarmWakeup') {
